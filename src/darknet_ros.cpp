...
#include <sia_darknet_ros/bbox_array.h>
#include <sia_darknet_ros/bbox.h>
...
//char datacfg[] = "/home/robot/catkin_hanker/src/sia_darknet_ros/src/cfg/coco.data";
//char cfgfile[] = "/home/robot/catkin_hanker/src/sia_darknet_ros/src/cfg/tiny-yolo.cfg";
//char weightfile[] = "/home/robot/catkin_hanker/src/sia_darknet_ros/src/tiny-yolo.weights";

//char datacfg[] = "/home/robot/catkin_hanker/src/sia_darknet_ros/src/cfg/voc.data";
//char cfgfile[] = "/home/robot/catkin_hanker/src/sia_darknet_ros/src/cfg/tiny-yolo-voc.cfg";
//char weightfile[] = "/home/robot/catkin_hanker/src/sia_darknet_ros/src/tiny-yolo-voc_final.weights";
char datacfg[] = "/home/robot/catkin_hanker/src/sia_darknet_ros/src/cfg/single.data";
char cfgfile[] = "/home/robot/catkin_hanker/src/sia_darknet_ros/src/cfg/tiny-yolo-single.cfg";
char weightfile[] = "/home/robot/catkin_hanker/src/sia_darknet_ros/src/tiny-yolo-single.weights";
...
// define parameters
const std::string CAMERA_COLOR_TOPIC = "/kinect2/hd/image_color_rect";	
const std::string CAMERA_DEPTH_TOPIC = "/kinect2/hd/image_depth_rect";
...
//    typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::Image, sensor_msgs::Image, sensor_msgs::CameraInfo, sensor_msgs::CameraInfo> ApproximateSyncPolicy;
    ...
    sia_darknet_ros::bbox_array _bbox_results_msg;
    ROS_box* boxes;
...
public:
          ...
          nh("~"), spinner(0), it(nh), mode(CLOUD), _class_bboxes(num_classes), _class_obj_count(num_classes, 0), _bbox_colors(num_classes)
    {
        ...
        _bboxes_pub = nh.advertise<sia_darknet_ros::bbox_array>("YOLO_bboxes", 1);
        ...
        cv::FileStorage fs("/home/robot/catkin_hanker/src/sia_darknet_ros/src/cam2arm.yml", cv::FileStorage::READ);
        fs["R_t"] >> cam2arm;
        fs.release();
...
//        }
        ...
        if(useExact)
        {
            syncExact = new message_filters::Synchronizer<ExactSyncPolicy>(ExactSyncPolicy(queueSize), *subImageColor, *subImageDepth);
            syncExact->registerCallback(boost::bind(&Receiver::callback, this, _1, _2));
        }
        else
        {
            syncApproximate = new message_filters::Synchronizer<ApproximateSyncPolicy>(ApproximateSyncPolicy(queueSize), *subImageColor, *subImageDepth);
            syncApproximate->registerCallback(boost::bind(&Receiver::callback, this, _1, _2));
        }
...
//            target_point.point.z = obj_loc[obj_index].z;
            target_point.point.x = obj_loc[obj_index].x;
            //target_point.point.y = obj_loc[obj_index].y;
            target_point.point.y = ((obj_loc[obj_index].y + results[0]) + (obj_loc[obj_index].y - results[1]))/2.0 + 0.02;
            target_point.point.z = obj_loc[obj_index].z;
            point_pub.publish(target_point);
...
{
    ros::init(argc, argv, "sia_darknet_ros");
